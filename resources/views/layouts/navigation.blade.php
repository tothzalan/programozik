        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link class="dark:text-gray-100" :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link class="dark:text-gray-100 " :href="route('projects.index')" :active="request()->routeIs('projects.index')">
                        {{ __('My projects') }}
                    </x-nav-link>
                </div>
            </div>
            {{-- Dark mode switch --}}
            <div class="flex-1 ml-8 mt-6">
